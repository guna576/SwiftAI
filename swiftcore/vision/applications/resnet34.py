...
class ResNet34:
    ...
    def build(inputShape=(224, 224, 3), classes=2):
        ...
        # block1
        x = ResNet34.res_module(x, 64, 1, red=True)
        x = ResNet34.res_module(x, 64, 1, )
        x = ResNet34.res_module(x, 64, 1, )

        # block2

        x = ResNet34.res_module(x, 128, 2, red=True)
        x = ResNet34.res_module(x, 128, 1)
        x = ResNet34.res_module(x, 128, 1)
        x = ResNet34.res_module(x, 128, 1)

        # block3
        x = ResNet34.res_module(x, 256, 2, red=True)
        x = ResNet34.res_module(x, 256, 1)
        x = ResNet34.res_module(x, 256, 1)
        x = ResNet34.res_module(x, 256, 1)
        x = ResNet34.res_module(x, 256, 1)
        x = ResNet34.res_module(x, 256, 1)
        ...
        # block4
        x = ResNet34.res_module(x, 512, 2, red=True)
        x = ResNet34.res_module(x, 512, 1)
        x = ResNet34.res_module(x, 512, 1)
